...
export default function Welcome() {
  ...
  return (
    <div className="casino-bg min-h-[100dvh] w-full flex items-center justify-center p-4 text-[#ece6da]">
      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} className="glass rounded-3xl p-5 sm:p-7 w-full max-w-sm text-center">
        <h1 className="font-display font-extrabold text-4xl sm:text-5xl tracking-tight mb-1" style={{ color: "#ffce3a", textShadow: "0 0 24px rgba(224,30,30,0.55), 0 3px 0 #a81212" }}>
        ...
        <div className="flex flex-col items-center mb-5">
          <div className="frame-ring w-20 h-20 sm:w-24 sm:h-24 mb-3"><img src={avatar} alt="" className="w-full h-full rounded-2xl object-cover" /></div>
